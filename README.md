...
+date https://clashnode.com/wp-content/uploads/%Y/%m/%Y%m%d.txt
# +date https://clashnode.com/wp-content/uploads/%Y/%m/%Y%m%d.yaml
!+date https://v2rayshare.com/wp-content/uploads/%Y/%m/%Y%m%d.txt
# !+date https://v2rayshare.com/wp-content/uploads/%Y/%m/%Y%m%d.yaml
!+date https://oneclash.cc/wp-content/uploads/%Y/%m/%Y%m%d.txt
# !+date https://oneclash.cc/wp-content/uploads/%Y/%m/%Y%m%d.yaml
!+date https://wefound.cc/freenode/%Y/%m/%Y%m%d.txt
# !+date https://wefound.cc/freenode/%Y/%m/%Y%m%d.yaml
